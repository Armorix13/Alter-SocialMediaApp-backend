...
import {
    IRegisterUser,
    IUpdateUserData,
} from "../types/Request Body/User/types";
import {
    IdeleteAccountQueryType,
    IgetProfileQueryType,
} from "../types/Request Query/User/types";

export const socail_login = async (
    ...
    try {
        ...
        userExists.isEmailVerified = isEmailVerified;
...
export const getProfile = async (
    req: Request<{}, {}, {}, IgetProfileQueryType>,
    res: Response,
    next: NextFunction
): Promise<any> => {
    try {
...
export const deleteAccount = async (
    req: Request<{}, {}, {}, IdeleteAccountQueryType>,
    res: Response,
    next: NextFunction
): Promise<any> => {
    try {
